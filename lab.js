...
/*
  ...
  use bracket or dot notation to add another key named 'car' with the value being your favorite car and then another key named 'show' with the value being your favorite show.
*/
...
let cat1 = new Cat('Sobe', 3, 'orange')
...
let wizard1 = new Wizard('jana', 148, 'Fireball')
...
/*
    ...
    sell should be a function that changes the value 
    of sold to true and prints the string: '{brand} {model} has been sold.'
...
//Code Here
let phone1 = new Phone('android', 'gen1', 09357, 'grey', 100.00)
let phone2 = new Phone('iPhone', 'gen9', 729485, 'yellow', 500.00) 
let phone3 = new Phone('samsung', 'gen5', 937294, 'purple', 1000.00)
